...
public class BinTreeNode implements BinTreePosition {
	...
	/**************************** 构造方法 ****************************/
	public BinTreeNode(){ this(null, null, true, null, null); }
		...
		BinTreePosition r)//右孩子
	{
		...
		//建立与父亲的关系
		if (null != p)
			if (asLChild) p.attachL(this); else p.attachR(this);
		//建立与孩子的关系
		if (null != l) attachL(l);
		if (null != r) attachR(r);
	}
	...
	public Object setElem(Object obj){ Object bak = element; element = obj; return bak; }
	/**************************** BinTreePosition接口方法 *************************/
	//判断是否有父亲（为使代码描述简洁）
	...
	public boolean isLChild(){ return (hasParent() && this == getParent().getLChild()) ? true : false; }
	//判断是否有左孩子（为使代码描述简洁）
	...
	public boolean isRChild(){ return (hasParent() && this == getParent().getRChild()) ? true : false; }
	//判断是否有右孩子（为使代码描述简洁）
